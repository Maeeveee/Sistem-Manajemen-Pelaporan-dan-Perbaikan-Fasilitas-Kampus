<main>
    <title>Sistem Manajemen Pelaporan dan Perbaikan Fasilitas Kampus - Daftar Akun</title>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                {{-- <p class="text-center"><a href="{{ route('dashboard') }}" class="text-gray-700"><i class="fas fa-angle-left me-2"></i> Kembali ke halaman utama</a></p> --}}
                            ...
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="email" id="email" type="email" class="form-control" placeholder="contoh@perusahaan.com" autofocus required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input wire:model.lazy="password" type="password" placeholder="Kata Sandi" class="form-control" id="password" required>
                                        </div>  
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input wire:model.lazy="passwordConfirmation" type="password" placeholder="Konfirmasi Kata Sandi" class="form-control" id="confirm_password" required>
                                        </div>  
                                    </div>
                                    <!-- End of Form -->
