<main>
    <title>Sistem Manajemen Pelaporan dan Perbaikan Fasilitas Kampus - Masuk Akun</title>
    <!-- Section -->
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-3 h3">Sistem Manajemen Pelaporan dan Perbaikan Fasilitas Kampus - Masuk Akun</h1>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="password" type="password" placeholder="Kata Sandi"
