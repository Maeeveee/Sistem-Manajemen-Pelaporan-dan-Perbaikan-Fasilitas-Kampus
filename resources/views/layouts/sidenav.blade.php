                ...
                @if (in_array(auth()->user()->role_id, $users))
                    <li class="nav-item {{ Request::routeIs('kerusakan.fasilitas') ? 'active' : '' }}">
                        <a href="{{ route('kerusakan.fasilitas') }}" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M18 13V6a2 2 0 00-2-2h-2V3a1 1 0 00-2 0v1H8V3a1 1 0 00-2 0v1H4a2 2 0 00-2 2v7h16zm0 2H2a1 1 0 000 2h16a1 1 0 000-2z" clip-rule="evenodd" />
                                </svg>
                            </span>
                ...
                @if (auth()->user()->role_id == 6)
                    ...
                    <li class="nav-item {{ Request::routeIs('manajemen.fasilitas') ? 'active' : '' }}">
                        <a href="{{ route('manajemen.fasilitas') }}" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M10 2a1 1 0 01.894.553l6 12A1 1 0 0116 16H4a1 1 0 01-.894-1.447l6-12A1 1 0 0110 2zm0 4a1 1 0 100 2 1 1 0 000-2zm1 4H9v4h2v-4z" clip-rule="evenodd" />
                                </svg>
                            </span>
                    ...
                    <li class="nav-item {{ Route::is('manajemen-periode') ? 'active' : '' }}">
                        <a href="{{ route('manajemen-periode') }}" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6 2a1 1 0 00-1 1v1H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 2V3h8v1H6zm10 2v10H4V6h12zm-2 2a1 1 0 10-2 0 1 1 0 002 0z"/>
                                </svg>
                            </span>
                    ...
                    <li class="nav-item {{ Request::segment(1) == 'admin' ? 'active' : '' }}">
                        <a href="/admin" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.257 3.099c.366-.446.993-.446 1.359 0l6.518 7.95A1 1 0 0115.518 13H4.482a1 1 0 01-.616-1.951l6.518-7.95zM11 13a1 1 0 11-2 0 1 1 0 012 0z"/>
                                </svg>
                            </span>
                ...
                @if (auth()->user()->role_id == 4)
                    ...
                    <li class="nav-item {{ Request::segment(1) == 'sarpras' ? 'active' : '' }}">
                        <a href="/sarpras" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 2a1 1 0 00-1 1v1H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2h-3V3a1 1 0 00-1-1H9zm0 2h2v1H9V4z"/>
                                </svg>
                            </span>
                            <span class="sidebar-text">Laporan Kerusakan</span>
                        </a>
                    ...
                    <li class="nav-item {{ Route::is('perhitungan-spk') ? 'active' : '' }}">
                        <a href="{{ route('perhitungan-spk') }}" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="3" height="10" x="4" y="7" rx="1"/>
                                    <rect width="3" height="6" x="9" y="11" rx="1"/>
                                    <rect width="3" height="14" x="14" y="3" rx="1"/>
                                </svg>
                            </span>
