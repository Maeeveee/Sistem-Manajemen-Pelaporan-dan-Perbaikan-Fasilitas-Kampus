<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-admin" aria-expanded="true">
          <span>
            <span class="sidebar-icon"><i class="fas fa-users me-2" style="color: White;"></i></span>
