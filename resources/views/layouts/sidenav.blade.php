                        ...
                        <a href="{{ route('manajemen-periode') }}" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M6 2a1 1 0 00-1 1v1H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 2V3h8v1H6zm10 2v10H4V6h12zm-2 2a1 1 0 10-2 0 1 1 0 002 0z" />
                                </svg>
                            </span>
                        ...
                        <a href="/admin" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M8.257 3.099c.366-.446.993-.446 1.359 0l6.518 7.95A1 1 0 0115.518 13H4.482a1 1 0 01-.616-1.951l6.518-7.95zM11 13a1 1 0 11-2 0 1 1 0 012 0z" />
                                </svg>
                            </span>
                        ...
                        <a href="/sarpras" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M9 2a1 1 0 00-1 1v1H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2h-3V3a1 1 0 00-1-1H9zm0 2h2v1H9V4z" />
                                </svg>
                            </span>
                            <span class="sidebar-text">Laporan Kerusakan</span>
                        </a>
